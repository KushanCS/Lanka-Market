...
public class CategoryService {
    ...
    @Autowired
    private com.example.lankamarket.features.category_management.CategoryRepository categoryRepository;

    // Create a new category with try-catch
    public com.example.lankamarket.features.category_management.Category createCategory(com.example.lankamarket.features.category_management.Category category) {
        try {
    ...
    public com.example.lankamarket.features.category_management.Category createCategory(String name) {
        try {
            com.example.lankamarket.features.category_management.Category category = new com.example.lankamarket.features.category_management.Category(name);
    ...
    public Optional<com.example.lankamarket.features.category_management.Category> getCategoryById(Long id) {
        try {
            if (id == null) {
    ...
    public com.example.lankamarket.features.category_management.Category getCategoryByIdOrThrow(Long id) {
        try {
            Optional<com.example.lankamarket.features.category_management.Category> category = getCategoryById(id);
    ...
    public Optional<com.example.lankamarket.features.category_management.Category> getCategoryByName(String name) {
        try {
    ...
    public List<com.example.lankamarket.features.category_management.Category> getAllActiveCategories() {
        try {
    ...
    public List<com.example.lankamarket.features.category_management.Category> getAllDeletedCategories() {
        try {
    ...
    public List<com.example.lankamarket.features.category_management.Category> getCategoriesOrderedByName() {
        try {
    ...
    public List<com.example.lankamarket.features.category_management.Category> getCategoriesOrderedByCreatedDate() {
        try {
    ...
    public com.example.lankamarket.features.category_management.Category updateCategory(Long id, com.example.lankamarket.features.category_management.Category updatedCategory) {
        try {
            if (id == null) {
                throw new IllegalArgumentException("Category ID cannot be null");
            }
            ...
            com.example.lankamarket.features.category_management.Category existingCategory = categoryRepository.findById(id)
    ...
    public void deleteCategory(Long id) {
        try {
            ...
            com.example.lankamarket.features.category_management.Category category = categoryRepository.findById(id)
                    .orElseThrow(() -> new RuntimeException("Category not found with ID: " + id));
    ...
    public com.example.lankamarket.features.category_management.Category restoreCategory(Long id) {
        try {
            if (id == null) {
                throw new IllegalArgumentException("Category ID cannot be null");
            }
    ...
    public List<com.example.lankamarket.features.category_management.Category> searchCategoriesByName(String name) {
        try {
            if (name == null || name.trim().isEmpty()) {
